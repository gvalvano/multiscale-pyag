...
from experiments.unet_pyag import BaseExperiment
...
class Experiment(BaseExperiment):
    def __init__(self, run_id=None, config=None):
        ...
        self.last_checkpoint_dir = '{0}/results/{1}/{2}/checkpoints/'.format(results_dir, self.args.experiment_type, self.args.dataset_name) + self.run_id
    ...
    def get_data(self):
        ...
        self.sup_train_init, self.sup_valid_init, self.sup_test_init, \
            self.sup_input_data, self.sup_output_scrib, self.sup_output_mask = \
            super(Experiment, self).get_acdc_sup_scribble_data(data_path=self.data_path, data_ids=self.data_ids,
